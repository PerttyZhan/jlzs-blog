...
class Information extends Model
{
    ...
    protected $fillable=['name','difference','headline','title','view','like','weight','mantle','sort_id','img_src','content','status','jsonsort_id','tag_id','user_id','collection','updated_at','created_at'];
    ...
    public function tag()
{
    return $this->belongsToMany('App\Model\InTag','information_intag','new_id','tag_id');
}
